...
public enum HDF5NativeType {
    ...
    /// Return the Swift type corresponding to the HDF5NativeType
    ...
    /// The raw value of the HDF5NativeType
    ...
    /// Create a HDF5NativeType from a Swift type
